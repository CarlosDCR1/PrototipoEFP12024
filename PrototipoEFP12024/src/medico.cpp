...
void MedicoCRUD::CrudMedicos() {
    ...
    do {
        system("cls");
        cout << "\t\t\t----------------------------------------------" << endl;
        cout << "\t\t\t| SISTEMA DE LABORATORIO - GESTION DE MEDICOS |" << endl;
        cout << "\t\t\t----------------------------------------------" << endl;
...
void MedicoCRUD::IngresarMedico() {
    ...
    if (ValidarMedico(medico.codigo)) {
        system("cls");
        cout << "El codigo del medico ya existe, intente de nuevo!!" << endl << endl << endl << endl;
        return;
    }
    ...
    cout << "Medico agregado exitosamente!" << endl;
}
...
void MedicoCRUD::ModificarMedico() {
    ...
    if (!encontrado) {
        cout << "No se encontró el medico con el codigo ingresado." << endl;
    } else {
...
void MedicoCRUD::BorrarMedico() {
    ...
    int codigo;
    cout << "\n------------------------------------------------------------------------------------------------------------------------" << endl;
    cout << "\n-------------------------------------------------Eliminar Medicos--------------------------------------------" << endl;
    cout << "Ingrese el codigo del medico a eliminar: ";
    cin >> codigo;
