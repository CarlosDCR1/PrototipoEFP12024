...
void resultados::asignacion_entr(const char* carnet) {
   system("cls");
    ...
    cout << "--ELIJA LA CLINICA A LA QUE DESEA IR ----" << endl;
    system("pause");
    ...
    while (!codigoValido) {
        ...
        cout << "Escriba el codigo de la clinica: " << endl;
        ...
        if (ValidarCL(resultados.codigoClinica)) {
            ...
            system("cls");
            cout << "El codigo de la clinica seleccionada no existe!! Intente de nuevo." << endl << endl;
            system("pause");
        }
    }

    cout << "Su Clinica ha sido asignada exitosamente" << endl;
    system("pause");
    system("cls");
    ...
    // ----------------------------------------ENTRADA Y VALIDACION DE SECCIONES-----------------------------------------------------
     ...
     cout << "---------------BIENVENIDO-----------------" << endl;
    cout << "-------ELIJA EL MEDICO QUE DESEA ---------" << endl;
    system("pause");
    ...
    while (!codigoValido) {
        ...
        cout << "Escriba el codigo del medico que desea :" << endl;
        ...
        if (ValidarME(resultados.codigoMedico)) {
            ...
            system("cls");
            cout << "El codigo del medico elegido no existe! Intente de nuevo." << endl << endl;
            system("pause");
        }
    }

    cout << "Medico Asignado exitosamente!" << endl;
    system("pause");
    system("cls");
    ...
    cout << "---------------BIENVENIDO-----------------" << endl;
    cout << "-------ELIJA EL HORARIO DE LA CITA---------" << endl;
    system("pause");
...
void resultados::desplegarBoleta(const char* carnet,string nombre) {
    ...
    bool encontrado ;
    cout << "+------------------------------------------------------------------------------------------------------------+" << endl;
    cout << "+                                       BIENVENIDO A NUESTRA CLINICA MEDICA!                                 +" << endl;
    cout << "+------------------------------------------------------------------------------------------------------------+" << endl;
    ...
    while (archivo.read(reinterpret_cast<char*>(&resultados), sizeof(Resultados))) {
            ...
            if ( resultados.carnet == scarnet) {
                ...
                cout << "--------------------------------------------------------------------------------------------------------------"<<endl;
                cout << "                      -> Nombre del Paciente: " << nombre << endl; // Mostrar el carnet
                cout << "                      -> Clinica elegida: " << ObtenerClinica(resultados.codigoClinica) << endl;
                cout << "                      -> Medico Seleccionado: " << ObtenerMedico(resultados.codigoMedico) << endl;
                cout << "---------------------------------------------------------------------------------------------------------------"<<endl;
                cout << "---------------------------------------------------------------------------------------------------------------"<<endl;
                cout << "|                                                  DATOS GENERALES LA CITA                                    | "<<endl;
                cout << "---------------------------------------------------------------------------------------------------------------"<<endl;
                ...
                cout << "                      -> Especialidad del medico: " << ObtenerMedicoESP(resultados.codigoMedico) << endl;
                cout << "                      -> Direccion de la clinica: " << ObtenerClinicaDIR(resultados.codigoClinica) << endl;
                cout << "--------------------------------------------------------------------------------------------------------------a"<<endl;
