...
void ClinicaCRUD::CrudClinicas() {
    ...
    do {
        system("cls");
        cout << "\t\t\t-----------------------------------------------" << endl;
        cout << "\t\t\t| SISTEMA DE LABORATORIO - GESTION DE CLINICAS |" << endl;
        cout << "\t\t\t-----------------------------------------------" << endl;
...
void ClinicaCRUD::IngresarClinica() {
    ...
    Clinica clinica;
    cout << "Ingrese el codigo de la clínica: ";
    cin >> clinica.codigo;
    cin.ignore();
    if (ValidarClinica(clinica.codigo)) {
        system("cls");
        cout << "El codigo de la clínica ya existe, intente de nuevo!!" << endl << endl << endl << endl;
        return;
    }
    ...
    cout << "Clínica agregada exitosamente!" << endl;
}
...
void ClinicaCRUD::ModificarClinica() {
    ...
    int codigo;
    cout << "Ingrese el codigo de la clínica a modificar: ";
    cin >> codigo;

    fstream archivo("Clinica.dat", ios::binary | ios::in | ios::out);
    if (!archivo) {
        cout << "No hay clínicas registradas." << endl;
        return;
    }
    ...
    if (!encontrada) {
        cout << "No se encontró la clínica con el código ingresado." << endl;
    } else {
        cout << "Clínica modificada exitosamente!" << endl;
    }
}
...
void ClinicaCRUD::BorrarClinica() {
    ...
    cout << "Ingrese el codigo de la clínica a eliminar: ";
    cin >> codigo;
