...
void entrenador::insertar()
{
    ...
    cout << "\t+------------------------------------------+" << endl;
    cout << "\t|\t\t            \t\t   |" << endl;
    cout << "\t|      Agregar detalles del Paciente\t   |" << endl;
    cout << "\t|\t\t            \t\t   |" << endl;
    cout << "\t+------------------------------------------+" << endl;
    cout << "\n";
    ...
    cout<<"        -> Generando codigo del paciente: " << entrenador.id<<endl;
    cin.ignore();

    cout<<"        -> Ingrese el 1er. nombre del paciente: ";
    cin.getline(entrenador.nom1, 45);

    cout<<"        -> Ingrese el 2do. nombre del paciente: ";
    cin.getline(entrenador.nom2, 45);

    cout<<"        -> Ingrese el 1er. apellido del paciente: ";
    cin.getline(entrenador.ape1, 45);

    cout<<"        -> Ingrese el 2do. apellido del paciente: ";
    cin.getline(entrenador.ape2, 45);

    cout<<"        -> Ingrese fecha de naciemineto del paciente: ";
...
void entrenador::desplegar()
{
    ...
    cout << "\t+------------------------------------------+" << endl;
    cout << "\t|\t\t            \t\t   |" << endl;
    cout << "\t|       Ver detalles del Paciente\t   |" << endl;
    cout << "\t|\t\t            \t\t   |" << endl;
    cout << "\t+------------------------------------------+" << endl;
    cout << "\n";
    ...
    if(!archivo)
    {
        ...
        while (archivo.read(reinterpret_cast<char*>(&entrenador), sizeof(Entrenador)))
        {
            ...
            cout<<"       -> 1er. Nombre del Paciente: "<< entrenador.nom1 << endl;
            cout<<"       -> 2do. Nombre del Paciente: "<< entrenador.nom2 << endl;
            cout<<"       -> 1er. Apellido del Paciente: "<< entrenador.ape1 << endl;
            cout<<"       -> 2er. Apellido del Paciente: "<< entrenador.ape2 << endl;
            cout<<"       -> Fecha de nacimiento del Paciente: "<< entrenador.fechan << endl;
            cout << "     +-----------------------------------------------+" << endl;
            cout << "\n";
        }
...
void entrenador::modificar()
{
    ...
    cout << "\t+------------------------------------------+" << endl;
    cout << "\t|\t\t            \t\t   |" << endl;
    cout << "\t|     Modificar detalles del Paciente\t   |" << endl;
    cout << "\t|\t\t            \t\t   |" << endl;
    cout << "\t+------------------------------------------+" << endl;
    cout << "\n";
    ...
    if (!encontrado) {
        cout << "       -> No se encontró un Paciente con el ID proporcionado." << endl;
        cout << "\n" << endl;
    }
...
void entrenador::borrar()
{
    ...
    cout << "\t+------------------------------------------+" << endl;
    cout << "\t|\t\t            \t\t   |" << endl;
    cout << "\t|     Eliminar detalles del Paciente\t   |" << endl;
    cout << "\t|\t\t            \t\t   |" << endl;
    cout << "\t+------------------------------------------+" << endl;
    cout << "\n";
    ...
    bool resta = false;
        ...
        {
        cout << "\n" << endl;
        cout << "       -> No se a podido encontrar al paciente" << endl;
        cout << "\n";
        }
}
